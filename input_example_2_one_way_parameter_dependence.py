...
# function and constraints for CHSH inequality with one-way parameter dependence.

####### Input Function and Constraints ############################################################################
############################################################################################

# main function. A string in latex format.
Function = ' (1 + 4m_1n_1 - 2m_1 - 2n_1) + (1 + 4m_2n_2 - 2m_2 - 2n_2) + (1 + 4m_3n_1 - 2m_3 - 2n_1) - (1 + 4m_4n_2 - 2m_4 - 2n_2) '
